...
import helpers from "../utils/landingHelper";
...
class leadModal extends React.Component {
  ...
  render() {
    return (
      <div>
        <button onClick={helpers.openModal}>Open Modal</button>
        <Modal
        ...
        >
          ...
          <div className="modal-card">
            ...
            <footer className="modal-card-foot">
              ...
              <button className="button is-danger" id="cancel" onClick={helpers.openModal}>Cancel</button>
            </footer>
          </div> 
        </Modal>
      </div>
